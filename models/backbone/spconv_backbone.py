...
class VoxelResBackBone8x(nn.Module):
    def __init__(self, model_cfg, input_channels, grid_size, **kwargs):
        ...
        last_pad = 0
        last_pad = self.model_cfg.get('last_pad', last_pad)
        self.conv_out = ConvModule(384 , 128, 1, norm_cfg=dict(type='SyncBN', eps=1e-3, momentum=0.01))
        # self.conv_out = spconv.SparseSequential(
        #     # [200, 150, 5] -> [200, 150, 2]
        #     spconv.SparseConv3d(384, 128, (3, 1, 1), stride=(2, 1, 1), padding=last_pad,
        #                         bias=False, indice_key='spconv_down2'),
        #     norm_fn(128),
        #     nn.ReLU(),
        # )
    ...
    def forward(self, voxel_features, voxel_coords, batch_size):
        ...
        spatial_features = x_conv4.dense()
